...
public class Levels : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        for (long i = 0; i < lines.LongLength; i++)
        {
            ...
            m_Levels[m_Levels.Count - 1].m_Rows.Add(line); //Sempre adicionando "linhas de level" ao o último level da lista de levels
        } 
    }
}
